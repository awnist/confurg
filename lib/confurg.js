...
(function() {
  ...
  confurg = module.exports = function(settings, defaults) {
    ...
    merged = {};
    _ref3 = [defaults, confurgFile(path.dirname(module.parent.filename) + "/config"), envs, confurgFile(process.env.HOME + ("/." + settings.namespace)), optimist];
